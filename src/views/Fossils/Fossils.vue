<template>
  <q-page padding class="text-center">
    <q-card>
      ...
      <q-card-section>
        <p>
          Les fossiles sont des objets précieux cachés dans le sol et présents
          dans toute la série Animal Crossing. Trouvables à l'aide d'une pelle,
          ils sont repérables grâce à une marque en forme d'étoile dans la
          terre. Dans les anciens opus, ils sont au nombre de 52.
        </p>
      </q-card-section>
    </q-card>
